...
urlpatterns = [
    ...
    path('all-hostels/<int:page_number>/', ListAllHostels.as_view(), name='list-all-hostels'),
    path('all-hostel-rooms', GetAllHostelsRooms.as_view(), name='get-all-hostel-rooms'),
    path('all-rooms-gender', GetAllRoomsGender.as_view(), name='get-all-rooms-gender'),
